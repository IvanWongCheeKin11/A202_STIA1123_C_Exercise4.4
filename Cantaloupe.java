...
class Cantaloupe extends Fruit {
    ...
    public Cantaloupe(String name, String colour, int stock) {
        super(name);
        this.colour = colour;
        this.stock = stock;
        System.out.println("Cantaloupe constructor is invoked");
